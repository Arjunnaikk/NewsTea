...
export class NewsItem extends Component {
  render() {
      ...
      return (
    <>
    <div className="card" style={{width: "22em",height:"28rem"}}>  <span class="position-absolute top-0 translate-middle badge rounded-pill bg-danger" style={{left:'90%',zIndex:"1"}}>
    {source}<span class="visually-hidden">unread messages</span></span>
